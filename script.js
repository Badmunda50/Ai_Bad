...
Please provide a response that takes into account the previous context.`;
            ...
            const response = await fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyBGnfbE6eHDvCAalHPmuMmVphMvUVyqYiQ', {
                method: 'POST',
                headers: {
